    ...
    <>
      ...
      <Jumbotron className="m-0">
        <Container>
          ...
          <p>
            Solid technological solutions create business and drive revenue. The right advice
            creates value, optimises business processes, releases resources and creates long-term
            client relationships. So of course we always do our best. We have done that since 2004,
      ...
      <Jumbotron className="m-0 bg-white">
        <Container>
          ...
          <p>
            ...
            development company and business partner, because we know what to do, and what not to
            do. In our opinion, value creation is all about coherence. Coherence between data.
            Between business processes across systems. Between you and the people you serve. Between
            you and us. Between your business challenge and our IT solution. It is up to you how
            early or late you want us to join the process. Now you know that our advice is at your
            service.
          </p>
        </Container>
      </Jumbotron>
      <Jumbotron className="m-0">
        <Container>
          ...
          <p>
            ...
            the best conditions for succeeding in creating value. Our advice hinges on all the
            things that will ensure this. This includes technological know-how, an understanding of
